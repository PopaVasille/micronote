        ...
        <div class="relative hidden md:block" @click.stop>
            ...
            <div v-if="showUserDropdown" class="absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-lg border border-gray-200 py-1 z-50">
                ...
                <div class="py-1">
                    ...
                    <Link v-if="!user.telegram_id && !user.whatsapp_id" :href="route('platform.selection')" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 transition-colors" @click="showUserDropdown = false">
        ...
        <div class="md:hidden relative" @click.stop>
            ...
            <div v-if="showMobileUserMenu" class="absolute right-0 mt-2 w-64 bg-white rounded-lg shadow-xl border border-gray-200 py-2 z-50">
                ...
                <div class="py-2">
                    ...
                    <Link v-if="!user.telegram_id && !user.whatsapp_id" :href="route('platform.selection')" class="flex items-center px-4 py-3 text-sm text-gray-700 hover:bg-gray-50 transition-colors" @click="showMobileUserMenu = false">
